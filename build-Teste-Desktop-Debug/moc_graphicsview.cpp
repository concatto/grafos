...
#include "../Teste/userInterface/graphicsview.h"
...
QT_MOC_LITERAL(22, 236, 11), // "resetCursor"
QT_MOC_LITERAL(23, 248, 19) // "askConnectionWeight"
    ...
    "performBFS\0performDFS\0resetCursor\0"
    "askConnectionWeight"
};
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 15: _t->askConnectionWeight((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (GraphicsView::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsView::performPrim)) {
                *result = 10;
                return;
            }
        }
        ...
        {
            typedef void (GraphicsView::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsView::performBFS)) {
                *result = 12;
                return;
            }
        }
        {
            typedef void (GraphicsView::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsView::performDFS)) {
                *result = 13;
                return;
            }
        }
