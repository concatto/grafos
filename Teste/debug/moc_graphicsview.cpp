...
QT_MOC_LITERAL(23, 251, 11), // "resetCursor"
QT_MOC_LITERAL(24, 263, 19) // "askConnectionWeight"
...
static const uint qt_meta_data_GraphicsView[] = {
 ...
 // signals: name, argc, parameters, tag, flags
      ...
      13,    1,  124,    2, 0x26 /* Public | MethodCloned */,
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 15: _t->resetCursor(); break;
        case 16: _t->askConnectionWeight((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (GraphicsView::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsView::computeMaxFlow)) {
                *result = 14;
            }
        }
    }
